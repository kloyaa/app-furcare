...
router.post('/payment/v1/:application/process', commonMiddlewares, processPayment);
router.get('/payment/v1/application/:application', commonMiddlewares, getPaymentsByApplication);
