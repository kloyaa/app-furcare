...
import { getAllApplications, getApplicationStatistics } from '../../controllers/__admin/application_controller';
 ...
 * @access Admin only
 */
router.get('/admin/v1/applications', getAllApplications);
 ...
 * @access Admin only
 */
router.get('/admin/v1/statistics', getApplicationStatistics);
