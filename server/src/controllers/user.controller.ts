...
import {
  findLastChangePassActivityByUser,
  findLastLoginByUser,
} from '../_core/services/user/user.service';
 ...
 */
export const getProfileByAccessToken = async (
  req: TRequest,
  res: Response
): Promise<void | Response> => {
  try {
    ...
    const _findLastChangePassActivityByUser =
      await findLastChangePassActivityByUser(toObjectId(user));
