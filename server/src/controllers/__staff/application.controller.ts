...
import { validateGetApplicationsByStatus, validateUpdateApplicationStatus, validateGetApplicationDetails } from '../../_core/validators/__staff/application.validator';
