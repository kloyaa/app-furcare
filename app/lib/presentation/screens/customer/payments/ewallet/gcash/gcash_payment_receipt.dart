...
class GCashPaymentReceiptScreen extends StatefulWidget {
  ...
  @override
  State<GCashPaymentReceiptScreen> createState() =>
      _GCashPaymentReceiptScreenState();
}

class _GCashPaymentReceiptScreenState extends State<GCashPaymentReceiptScreen>
      ...
      child: Column(
        ...
        children: [
          ...
          CustomText.body(
            ...
            '• GCash payment processing may take 1-3 business days\n'
