...
class _AppointmentsScreenState extends State<AppointmentsScreen>
  ...
  void initState() {
    ...
    Future.microtask(() {
      if (mounted) {
        context.read<AppointmentProvider>().getHomeServiceAppointments();
      }
    });
  }
      ...
      body: RefreshIndicator(
        ...
        child: Consumer<AppointmentProvider>(
          builder: (context, appointmentProvider, child) {
            final appointments = appointmentProvider.homeServiceAppointments;
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return AnimatedContainer(
                    ...
                    child: _HomeServiceAppointmentCard(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          CustomText.body(
            'No home service appointments found',
            style: TextStyle(
          ...
          Text(
            'Create your first home service appointment',
            style: TextStyle(
...
class _HomeServiceAppointmentCard extends StatefulWidget {
  ...
  const _HomeServiceAppointmentCard({
  ...
  @override
  State<_HomeServiceAppointmentCard> createState() =>
      _HomeServiceAppointmentCardState();
}

class _HomeServiceAppointmentCardState
    extends State<_HomeServiceAppointmentCard>
